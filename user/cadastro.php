...
<body>
    <div id="conteudo">
        ...
        <div class="borda"></div>
        <?php
            $refresh = '<meta http-equiv="refresh" content="5; url=formCadastro.php">'; // meta tag para voltar à página de formCadastro
            ...
            $filtraPergunta = filter_var($recebePergunta, FILTER_SANITIZE_SPECIAL_CHARS);
            $filtraPergunta = filter_var($filtraPergunta, FILTER_SANITIZE_ADD_SLASHES);
            ...
            if ($verificaBanco == 1) {
                ...
                if($criptoSenha != $cripto_confSenha){
                    ...
                    VALUES ('$filtraNome', '$filtraEmail', $filtraIdade,'$criptoSenha', '$filtraPergunta', '$filtraResposta', 'Usuário')") or die(mysqli_error($conecta));
                    ...
                    echo "<strong>Pergunta</strong>: $filtraPergunta<br>";
